...
public class TrapsLayoutFragment extends Fragment {
    ...
    public static TrapsLayoutFragment newInstance(String param1, String param2, String param3) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mParam3 != null) {
            TextView instructionView = view.findViewById(R.id.traps_instructions);
        ...
        if(textSize = sharedPreferences.getBoolean("large_text", false)) {
            TextView title = view.findViewById(R.id.traps_title);
            TextView instructions = view.findViewById(R.id.traps_instructions);
